...
resize_image = image.resize((125, 75))
...
txt.place(x = 700, y = 260)'''

txt_1=random.randint(1,100)
txt_2=random.randint(1,10)
 
lbl2 = tk.Label(window, text ="Name",
width = 10, fg ="blue", bg ="white",
height = 2, font =('times', 15, ' bold '))
lbl2.place(x = 500, y = 350)
 
txt2 = tk.Entry(window, width = 20,
bg ="white", fg ="blue",
font = ('times', 15, ' bold ')  )
txt2.place(x = 700, y = 360)
    ...
    while True:
        ...
        for(x, y, w, h) in faces:
            ...
            if(conf < 50):
                ...
                # def greet():
                #     if tt in ['Kalpana','SivaRamanaHV']:
                #         return 'Doctor'
                #     else:
                #         return 'Sir'
                
                file = gTTS(text="வரவேற்கிறேன் திரு,"+str(aa), lang='ta', slow=False)
                
                audio = str(r1)+"output"+str(r2)+".mp3"
                file.save(audio)
